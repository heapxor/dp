...
\subsection{Mechanizmy pre správu chýb}

\subsection{Perzistentné úložisko}



perzistentn=e uloziskoa
Tento systém bol primárne navrhnutý tak aby spracúval vysoký tok pre zápis, s tým že čo najmenej ovlplyvní efektívnosť operácií na čítanie. Hlavné vlastnosti popíšeme v následujúcej časti textu.
